...
<body>
    ...
    <div class="main">
        ...
        <div class="second-main">
            <div class="box2">
                <ul>
                    <li><img src="../media/mk.jpg"></li>
                    <li><img src="../media/gk.jpg"></li>
                    <li><img src="../media/w.jpg"></li>
                    <li><img src="../media/tj.jpg"></li>
                    <li><img src="../media/ro.jpg"></li>
                    <li><img src="../media/cm2.jpg"></li>
                    <li><img src="../media/thr.png"></li>
                </ul>
            </div>
        </div>
        <div class="third-main">
            <div class="box3">
                <ul>
                    <ul>
                        <li><br><img src="../media/firstN.jpeg"></li>
